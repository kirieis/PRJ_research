      ...
      <main className="flex-1 flex items-center justify-center p-6 z-10 my-8">
        <div className="w-full max-w-5xl grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-6">
            <h1 className="text-7xl lg:text-[5rem] xl:text-[6rem] font-black tracking-tighter leading-[0.8] font-[var(--font-instrument)] uppercase break-words">
              <span className="text-[#111] block mb-2">CREATE</span>
              <span className="text-[#A63A2E] block">ACCOUNT.</span>
            </h1>
            <p className="text-[#666] text-lg max-w-md leading-relaxed mt-8">
              Tạo tài khoản ngay hôm nay để trải nghiệm phòng đàm thoại ẩn danh chuẩn HD và kết nối thực hành ngôn ngữ.
            </p>
          </div>

          {/* Right Side: Light Register Card */}
          <div className="bg-white border border-[#E5E5E5] rounded-xl p-8 lg:p-10 shadow-[0_8px_30px_rgb(0,0,0,0.04)] relative">
            <div className="mb-8">
              <h2 className="text-2xl font-bold tracking-tight text-[#111] mb-2 font-[var(--font-instrument)]">Đăng Ký Tài Khoản</h2>
              <p className="text-xs font-sans text-[#666] uppercase tracking-widest">Điền thông tin để tạo tài khoản mới</p>
            </div>
            ...
            {successMsg && (
              <div className="mb-6 p-4 rounded-xl bg-[#F0FFF4] border border-[#C6F6D5] text-[#2F855A] text-sm font-medium">
                {successMsg}
              </div>
            )}
            ...
            <form onSubmit={handleRegister} className="space-y-4">
              <div>
                ...
                <input
                  ...
                  placeholder="Ví dụ: Thien Nguyen"
            ...
            <div className="mt-8 text-center text-xs text-[#666]">
              Đã có tài khoản?{" "}
              <a href="/login" className="text-[#A63A2E] font-bold hover:underline ml-1">
                Đăng nhập ngay
              </a>
            </div>
          </div>
